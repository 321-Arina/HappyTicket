...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView ticketInfoOut; // поле вывода результата
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(algorithm.isHappyTicket(ticketNumber)) { // если номер билета счастливый, то об этом выводится информация на экран
                ticketInfoOut.setText("Данный номер билета счастливый " + algorithm.nextHappyTicketV2(ticketNumber));
            } else { // иначе, производится поиск данного билета с последующим выводом на экран
                ticketInfoOut.setText("Данный номер билета не счастливый, следующим счаcтливым номером является "
